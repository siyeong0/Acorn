...
namespace aco
{
	...
	struct FVector4
	{
		...
		static inline FVector4 UnitX() { return FVector4{ 1.f, 0.f, 0.f, 0.f }; }
		static inline FVector4 UnitY() { return FVector4{ 0.f, 1.f, 0.f, 0.f }; }
		static inline FVector4 UnitZ() { return FVector4{ 0.f, 0.f, 1.f, 0.f }; }
		static inline FVector4 UnitW() { return FVector4{ 0.f, 0.f, 0.f, 1.f }; }
	...
	inline void FVector4::operator+=(const FVector4& other)
	{
		x += other.x;
		y += other.y;
		z += other.z;
	...
	inline void FVector4::operator*=(FLOAT v)
	{
		x *= v;
		y *= v;
		z *= v;
